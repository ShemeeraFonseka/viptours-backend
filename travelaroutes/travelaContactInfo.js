...
import ContactInfo from '../travelamodels/TravelaContactInfo.js';
...
router.post('/', async (req, res) => {
  const { office, mobile, email, mapUrl } = req.body;
  ...
  try {
    const newInfo = new ContactInfo({ office, mobile, email, mapUrl });
